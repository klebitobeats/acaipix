...
// --- Função de pagamento via Pix (Mercado Pago) ---
function handlePixPayment() {
  fetch("https://acaiteria-in2c.vercel.app/api/create-pix-payment", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({
      amount: 35.90,
      description: "Pedido App Açaí",
  ...
  .then(data => {
    if (data.qrCodeBase64) {
      const qrDiv = document.getElementById("pix-area");
      qrDiv.innerHTML = ""; 
